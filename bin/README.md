...
|---------|-------------|---------|
| IBM i Host | Hostname of the IBM i system | `as400.example.com` |
...
Configured environments:
  dev (default) — longdm@as400.example.com lib=LONGDM
  qa — longdm@as400.example.com lib=QALIB
  prod — longdm@as400.example.com lib=PRODLIB
```
...
pwsh -ExecutionPolicy Bypass -File bin/cpysrc.ps1 MYPGM -Library PRODLIB -File ILESRC
```
...
pwsh -ExecutionPolicy Bypass -File bin/putsrc.ps1 MYPGM -Library QALIB
```

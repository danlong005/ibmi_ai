...
|---------|-------------|---------|
| IBM i Host | Hostname of the IBM i system | `myhost.example.com` |
...
pwsh -ExecutionPolicy Bypass -File bin/cpysrc.ps1 MYPGM -Library MYLIB -File ILESRC
```
...
pwsh -ExecutionPolicy Bypass -File bin/putsrc.ps1 MYPGM -Library MYLIB
```

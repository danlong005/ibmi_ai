...
```dds
     ...
     A                                          DATFMT(*ISO)
     A            BCAFRAN   R                   REFFLD(PPFRAN)
     A            BCAPOL    R                   REFFLD(PPPOL)
...
| File type | Command |
|-----------|---------|
| Physical file | `CRTPF FILE(lib/name) SRCFILE(lib/ILESRC) SRCMBR(name)` |
| Logical file | `CRTLF FILE(lib/name) SRCFILE(lib/ILESRC) SRCMBR(name)` |
